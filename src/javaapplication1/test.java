...
public class test extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        searchMenuButton = new javax.swing.JMenu();
        ...
        sortButton.setText("Сортировать по фамилии");
        ...
        searchMenuButton.setText("Поиск");

        jMenuItem1.setText("Поиск по фамилии");
        jMenuItem1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem1ActionPerformed(evt);
            }
        });
        searchMenuButton.add(jMenuItem1);

        jMenuBar1.add(searchMenuButton);
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(athleteButton, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(parentPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 278, Short.MAX_VALUE)
    ...
    //открыть окно для поиска
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        searchForm sForm = new searchForm();
        sForm.setVisible(true);
    }//GEN-LAST:event_jMenuItem1ActionPerformed

    //сделать соритровку по фамилиям
    private void sortButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sortButtonActionPerformed
        for (int i = 0; i < mainTM.getRowCount(); i++)
        {
            for (int j = i + 1; j < mainTM.getRowCount(); j++)
            {
                if (String.valueOf(mainTM.getValueAt(i, 0)).compareTo(String.valueOf(mainTM.getValueAt(j, 0))) > 0)
                {
                    if (lastPanel == athletePanel){
                        int temp = idOfAthlete.get(i);
                        idOfAthlete.set(i, idOfAthlete.get(j));
                        idOfAthlete.set(j, temp);
                        mainTM.moveRow(i, j - 1, 1);
                    }
                    else if (lastPanel == parentPanel){
                        int temp = idOfParent.get(i);
                        idOfParent.set(i, idOfParent.get(j));
                        idOfParent.set(j, temp);
                        mainTM.moveRow(i, j - 1, 1);
                    }
                    else if (lastPanel == coachPanel){
                        int temp = idOfCoach.get(i);
                        idOfCoach.set(i, idOfCoach.get(j));
                        idOfCoach.set(j, temp);
                        mainTM.moveRow(i, j - 1, 1);
                    }
                }
            }
    ...
    private javax.swing.JMenu searchMenuButton;
